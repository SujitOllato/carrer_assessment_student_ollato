                    ...
                    <div className='process-lavel text-center'>
                      ...
                      <div className='lavel'>
                        <button
                          ...
                          disabled={
                            !dashboardData?.assessmentTest || dashboardData?.assessmentTest?.is_submitted === 0
                          }
                    ...
                    <div className='progress-lavel'>
                      <div className='progress-graph'>
                        <button
                          ...
                          // }
                          disabled={!dashboardData?.assessmentTest ||
                    ...
                    <div className='progress-lavel'>
                      <div className='progress-graph'>
                        <button
                          ...
                          //     : false
                          // }
                          disabled={!dashboardData?.studentTestData || dashboardData?.studentTestData?.find(i => i.title === 'Aptitude Test').completed_percent === 0
                        }
                    ...
                    <div className='progress-lavel'>
                      <div className='progress-graph'>
                        <button
                          ...
                          //     : false
                          // }
                          disabled={!dashboardData?.studentTestData || dashboardData?.studentTestData?.find(i => i.title === 'Interest Test').completed_percent === 0
                        }
