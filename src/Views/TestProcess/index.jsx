// // src/Views/TestProcess/TestProcess.jsx
...
//   /* ---------- Effects ---------- */
//   /* 1. Fetch test‑process data on load */
//   useEffect(() => {
//     if (token) dispatch(getTestProcess(token))
//   }, [token])

//   /* 2. Set default tab & test type after data arrives or route state changes */
//   useEffect(() => {
//     if (!testProcessArray) return

//     if (location.state === null) {
//       /* Landed from menu → open first tab */
//       setKey(testProcessArray[0]?.title)
//       setTestType(testProcessArray[0]?.title)
//     } else if (location?.state?.key) {
//       /* Deep‑link from elsewhere */
//       setKey(location.state.key)
//       setTestType(location.state.key)
//     }
//   }, [testProcessArray, location?.state])

//   /* 3. When user finishes an Interest Test, force tab switch */
//   useEffect(() => {
...
//   /* ---------- Helpers ---------- */
//   const handleId = (id) => setInterestId(id)
...
//                             __html: testProcessArray[1]?.description
//                           }}
//                         />
//                         <div className="inner-box d-flex align-items-center">
//                           <h4>
//                             <img src={queansline} alt="Question icon" /> 90 Questions
//                           </h4>
//                         </div>
//                       </div>

//                       <div className="right-box d-md-block text-end">
//                         {testProcessArray[1]?.studentInterestTest ? (
...
//                           <>
//                             <Link
//                               to="/test-process/test-question/interest-test"
//                               state={{ id: interestId }}
...
//                   </div>
//                 ) : (
//                   /* ===== All other category tests ===== */
//                   testProcessArray.map((cat) =>
//                     cat.test_details.map((d) => (
//                       <Tab.Pane key={d.id} eventKey={cat.title}>
//                         <ul className="pl-0">
...
//                               <div className="inner-box d-flex align-items-center">
//                                 <h4>
//                                   <img src={queansline} alt="Question icon" />{' '}
//                                   {d.no_of_questions} Questions
//                                 </h4>

//                                 {d.test_time && (
//                                   <h4>
//                                     <img src={timerline} alt="Timer icon" />{' '}
//                                     {d.test_time.time_Sec
//                                       ? moment
//                                           .utc(d.test_time.time_Sec * 1000)
//                                           .format('mm')
//                                       : '0'}{' '}
//                                     Minutes
//                                   </h4>
...
//             </Tab.Container>
//           ) : (
//             <div className="main-layout test-process-tab">No Data Found</div>
//           )}
//         </div>
//       </div>
//     </>
