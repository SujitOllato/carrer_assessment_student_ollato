    ...
    <>
      <div className="main-layout whitebox-layout my-profile-page">
        <div className="profilebutton-box text-end">
          <Link
            to="/settings/my-profile/editmyprofile"
          ...
          <div className="row">
                  ...
                  <div className="col-xl-8">
                    <div className="profileinfo profile-updated">
                      <div className="profile-img ">
                        <img
                          src={
                            data?.profile !== null ? profileImage : defaultImage
                          }
                          alt="ollato-img"
                        />
                      </div>
            ...
            <div className="col-xl-6">
              <div className="profile-item">
                ...
                <h4>
                  {data?.studentDetails?.school_address_1 !== null
                    ? data?.studentDetails?.school_address_1 +
                      ' ' +
                      data?.studentDetails?.school_address_2
                    : '-'}
                </h4>
              </div>
            </div>
